                            ...
                            <ul>
                                ...
                                <li class="c-position-relative">
                                    @if ($thread->replies_count > 0)
                                        <span class="cookme-comments c-position-static"><i class="fa fa-comments-o" aria-hidden="true"></i>&nbsp;<span class="thread-replies-count" v-text="repliesCount"></span></span>

                                    @else
                                        <span class="cookme-comments c-position-static"><i class="fa fa-comments-o no-comments" aria-hidden="true"></i>&nbsp;<span class="thread-replies-count" v-text="repliesCount"></span></span>
                                    @endif
                                </li>
                            </ul>
